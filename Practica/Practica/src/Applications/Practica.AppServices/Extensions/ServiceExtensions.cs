...
using Domain.UseCase.PersonaUseCases;
using DrivenAdapter.Dapper;
using DrivenAdapter.Files;
using DrivenAdapters.Mongo;
using DrivenAdapters.Mongo.Entities;
using Microsoft.Extensions.DependencyInjection;
using Practica.AppServices.Automapper;
using StackExchange.Redis;
using System;

namespace Practica.AppServices.Extensions
{
    /// <summary>
    /// Service Extensions
    /// </summary>
    public static class ServiceExtensions
    {
        ...
        public static IServiceCollection RegisterServices(this IServiceCollection services)
        {
            ...
            services.AddScoped<IPersonaRepository, PersonaAdapter>();
            services.AddScoped<IConnection, Conecction>();

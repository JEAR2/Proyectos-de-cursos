...
using System.IO;
using System.Linq;
using DrivenAdapter.grpc.Service;
...
builder.Services
    ...
    .RegisterAutoMapper()
    .RegisterAsyncGateways(secrets.ServiceBusConnection)
    .RegisterAsyncGatewaysUserRequest(secrets.ServiceBusConnection)
    .RegisterServices()
...
var appUserCommandSubscription = app.Services.GetRequiredService<IUserCommandSubscription>();

appUserCommandSubscription.SubscribeAsync().Wait();
